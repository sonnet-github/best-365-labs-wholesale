...
<div class="full-width-image-banner block--custom-layout__full-width-image-banner">
    <div class="full-width-image-banner__image">
        <img decoding="async" class="desktop" src="http://localhost:10034/wp-content/uploads/2025/04/308eba_2776e2be558d463f937a03db1e45a275mv2-1.avif" alt="">
        <img decoding="async" class="mobile" src="http://localhost:10034/wp-content/uploads/2025/04/308eba_2776e2be558d463f937a03db1e45a275mv2.avif" alt="">
    </div>
</div>

<div class="blog-listing block--custom-layout__blog-listing">
    <div class="blog-listing__container">
    <div class="blog-listing__title">
        
        <h1>News &amp; Information</h1>
        <p>Information from our Medical Advisors and Best 365 Labs’ products featured in news and other media outlets.</p>
    </div>

    <?php
        $custom_order = ['in-the-media', 'dr-warren', 'dr-gardner', 'health-wellness']; // replace with your actual slugs
